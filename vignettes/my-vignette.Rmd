...
g_weighted <- add_edge_weight(g, variables = c("elevation", "temperature", "precipitation"))
```
...
```{r skater}
# Generate 3 fuzzy regions from 100 random spanning trees
...
classes. RGB and ternary plots require exactly 3 classes.
